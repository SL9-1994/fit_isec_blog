+++
title = "「福岡工業大学 非公式情報セキュリティサークル・FIT ISec」(入部方法)"
description = "fit-isec"
...
`FIT-ISec`は福岡工業大学の学内団体 (非公式) であり，主に情報セキュリティに関しての研究や実践，学習を行っています．<br>
創設者兼リーダーは情報工学科の B2(2026 年現在)です．<br>
僕自身も，情報工学やサイバーセキュリティに関して初学者ですので，メンバー同士で高め合えるサークルにしたいと考えております！
基本的には独学で学習し，わからない部分などを適宜メンバー同士で話し合う形式です．
...
- 基礎的なLinux操作が可能なこと (パッケージマネージャやファイル操作など)
- まずは自分で調べることができること
- 情報技術者倫理を理解し，実践できること
- 技術に対して興味をもっていること
- 単一のプログラミング言語に対して触れたことがあること (HTML・CSSなどは除き，一般的にプログラミング言語であると定義されるもの)
...
参加には，Microsoft Formsでの簡単な入部テストを設けております．
